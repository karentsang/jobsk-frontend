<template>
    <div class="header" style="width: 100%; display: flex; margin-top: 62px;">
        ...
        <vs-button  style="text-align: center; width: 20%; padding:0px" color="#ff7e67" type="flat">Join</vs-button>
