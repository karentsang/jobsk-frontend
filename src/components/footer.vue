<template>
    <div>
        ...
        <footer style="display: flex; margin-top: 9px; background-color: rgb(50,75,125); width: 100%; height: 100px;">
            <div style="width: 50%; margin: auto; text-align: center;">
                <img style="width: 125px;" src="https://res.cloudinary.com/suang/image/upload/v1567573042/JOBSK/Screen_Shot_2019-09-04_at_12.56.46_PM_crpiuv.png"/>
